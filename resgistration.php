    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.html"
          ><img src="img/logo.png" alt="" class="logopng"
        /></a>
        <button
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li>
                  <a class="dropdown-item" href="bba.html"
                    >Department Business Administration</a
                  >
                </li>
                <li>
                ...
                <li>
                  <a class="dropdown-item" href="#"
                    >Department Of Islamic Studies</a
                  >
                </li>
                <li>
                  <hr class="dropdown-divider" />
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li>
                  <a class="dropdown-item" href="#"
                    >Guide line for Tuition Fees Payment System</a
                  >
                </li>
                <li>
                  <hr class="dropdown-divider" />
            ...
            <div class="footer-menu">
              ...
              <ul id="menu-quick-links" class="footer-menu-list">
                ...
                <li
                  class="menu-item menu-item-type-custom menu-item-object-custom"
                >
                  <a target="_blank" rel="noopener noreferrer" href="about.html"
                    >About</a
                  >
                </li>
                <li
