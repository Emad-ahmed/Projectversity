        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li>
                <a class="dropdown-item" href="bba.php">Department Business Administration</a>
              </li>
              <li>
              ...
              <li>
                <a class="dropdown-item" href="#">Department Of Civil Engineering</a>
              </li>
              <li>
                <hr class="dropdown-divider" />
              </li>
              <li>
                <a class="dropdown-item" href="#">Department Of Architecture</a>
              </li>
              <li>
                <hr class="dropdown-divider" />
              </li>
              ...
              <li>
                <a class="dropdown-item" href="#">Department Of Islamic Studies</a>
              </li>
              <li>
                <hr class="dropdown-divider" />
              </li>
              <li>
                <a class="dropdown-item" href="#">Department Of Bangla</a>
              </li>
            </ul>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <li>
                <a class="dropdown-item" href="#">Programmer’s Rank-list</a>
              </li>
              <li>
                <hr class="dropdown-divider" />
              </li>
      ...
      <div class="row clearfix">
        <div>
          <form onsubmit="return formValidation()">
            ...
            <div class="input_field mb-0">
              <span><i aria-hidden="true" class="fa fa-id-badge"></i></span>
              <input type="text" name="id_no" id="id_no" placeholder="Id No" required />
              <p class="mt-0 errorp" id="iderror"></p>
            </div>
        ...
        <div class="footer-content-column">
          ...
          <div class="footer-call-to-action">
            ...
            <p class="footer-call-to-action-link-wrapper">
              <a class="footer-call-to-action-link" href="tel:01312241148" target="_self">
                +8801312241148
              </a>
            </p>
          </div>
        ...
        <div class="footer-copyright-wrapper">
          <p class="footer-copyright-text">
            <a class="footer-copyright-link" href="#" target="_self">
              ©2022. | Designed By: Emad Ahmed. | All rights reserved.
            </a>
          </p>
        </div>
      </div>
